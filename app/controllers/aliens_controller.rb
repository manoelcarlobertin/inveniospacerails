class AliensController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @alien.save
        format.html { redirect_to alien_url(@alien), notice: "Alien was successfully created." }
  ...
  def update
    respond_to do |format|
      if @alien.update(alien_params)
        format.html { redirect_to alien_url(@alien), notice: "Alien was successfully updated." }
